(function () {
  ...
  var packingGroups = [
    ...
    { name: 'Kid comfort (6-year-old)', items: ['Booster limits, expiry, recalls & belt fit checked; secure it when empty', 'Apple AirTag for Nolan — fresh battery, paired in Find My, and tested before departure', 'Car snacks restocked daily', 'Water bottles', 'Car toys / activity bag', 'Tablet + headphones, charged', 'Comfort item for hotels', 'Motion sickness plan (bags, wipes, meds if used)'] },
